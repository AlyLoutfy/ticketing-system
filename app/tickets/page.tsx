        ...
        <div className="bg-white shadow-sm border-b px-6 py-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500">Manage and track all tickets</p>
            </div>
                            ...
                            <TableCell>
                              <div className="flex items-center gap-1">
                                ...
                                {ticket.status !== "Closed" && (
                                  <Button variant="ghost" size="sm" onClick={() => handleCloseTicket(ticket.id)} className="text-gray-600 hover:text-gray-700">
                                    <X className="w-4 h-4" />
                                  </Button>
                                )}
                              </div>
